...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Libre+Baskerville:400i|Montserrat&display=swap" rel="stylesheet" />
<?php
...
@keyframes pulse {
  from {
    box-shadow: 1px 1px 5px #285d67;
  }

  50% {
    box-shadow: 1px 1px 15px #285d67;
  }
  ...
  <body>     
      ...
      <a href="index.html">
          ...
          <div class="pulse_button"><p>great!</p></div>
      </a>
  </body>
  </html>
